...
public:
    DeicsOnzeGuiBase( QWidget* parent = 0, const char* name = 0, bool modal = FALSE, WFlags fl = 0 );
    ~DeicsOnzeGuiBase();
    ...
    QSpinBox* LS1SpinBox;
    QSpinBox* RS1SpinBox;
    QGroupBox* Vol1groupBox;
    QSlider* Vol1Slider;
    QSpinBox* Vol1SpinBox;
    QGroupBox* sensitivity1groupBox;
    QLabel* EGS1Label;
    QLabel* KVS1Label;
    ...
    QSpinBox* LS2SpinBox;
    QSpinBox* RS2SpinBox;
    QGroupBox* Vol2groupBox;
    QSlider* Vol2Slider;
    QSpinBox* Vol2SpinBox;
    QGroupBox* sensitivity2groupBox;
    QLabel* EGS2Label;
    QLabel* KVS2Label;
    ...
    QSpinBox* LS3SpinBox;
    QSpinBox* RS3SpinBox;
    QGroupBox* Vol3groupBox;
    QSlider* Vol3Slider;
    QSpinBox* Vol3SpinBox;
    QGroupBox* sensitivity3groupBox;
    QLabel* EGS3Label;
    QLabel* KVS3Label;
    ...
    QSpinBox* RR4SpinBox;
    QSpinBox* AR4SpinBox;
    QGroupBox* Vol4groupBox;
    QSlider* Vol4Slider;
    QSpinBox* Vol4SpinBox;
    QGroupBox* sensitivity4groupBox;
    QLabel* EGS4Label;
    QLabel* KVS4Label;
