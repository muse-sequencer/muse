...
class QTreeCategory:public QListViewItem {
 public:
    Category* _category;
    QTreeCategory(QListView* p, QString shbank, QString l, Category* c)
	:QListViewItem(p) {
      	setText(0, shbank);
      	setText(1, l);
      	_category=c;
...
class QTreeSubcategory:public QListViewItem {
 public:
  Subcategory* _subcategory;
  QTreeSubcategory(QListView* p, QString slbank,
...
class QTreePreset:public QListViewItem {
 public:
    Preset* _preset;
    QTreePreset(QListView* pa, QString sprog, QString l, Preset* p)
	:QListViewItem(pa) {
            setText(0, sprog);
            setText(1, l);
           _preset=p;
