...
CtrlPanel::CtrlPanel(QWidget* parent, MidiEditor* e, const char* name)
   : QWidget(parent, name)
      ...
      QHBoxLayout* bbox = new QHBoxLayout(vbox);
      vbox->addStretch();
      QHBoxLayout* kbox = new QHBoxLayout(vbox);
      QHBoxLayout* dbox = new QHBoxLayout(vbox);
      vbox->addStretch();
      ...
      _dl->setBackgroundMode(PaletteMid);
      _dl->setFrame(true);
