...
//                 if (pclass & MusEPlugin::PluginClassInstrument)
//                    type_name = tr("dssi synth");
//                 else
//                    type_name = tr("dssi effect");
//                 plugInstanceType = SEL_TYPE_DSSI;
...
//                 type_name = tr("Wine VST");
//                 //if (pclass & MusEPlugin::PluginClassInstrument)
//                 //  type_name = tr("Wine VST synth");
//                 //else
//                 //  type_name = tr("Wine VST effect");
//                 plugInstanceType = SEL_TYPE_WINE_VST;
//               break;
//
...
//
// // //             if((*i)->isDssiSynth() || (*i)->isDssiPlugin()) {
// //             if(ptype == MusEPlugin::PluginTypeDSSI || ptype == MusEPlugin::PluginTypeDSSIVST) {
// //
// // //                if ((*i)->lib() == "dssi-vst") {
// //                if (ptype == MusEPlugin::PluginTypeDSSIVST) {
// //
// //                   type_name = tr("Wine VST");
// //                   plugInstanceType = SEL_TYPE_WINE_VST;
// //                } else {
