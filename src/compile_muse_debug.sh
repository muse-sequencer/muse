...
echo " ==================================== "
cmake -S . -B ../build_debug  -DCMAKE_BUILD_TYPE=Debug  -DMODULES_BUILD_STATIC=ON  -DMUSE_ENABLE_ASAN=ON
...
case "$answer" in
    [Yy]) echo "Starting installation. " && sudo  cmake --install ../build_debug ;;
