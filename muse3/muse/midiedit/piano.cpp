...
{
    static constexpr qreal keyHeightW = KH;
    static constexpr qreal keyHeightB = 7.;
    static constexpr qreal distSmallB = 6.;
    static constexpr qreal distLargeB = 19.;
    static constexpr qreal topOffsetB = 10.;
    static constexpr qreal octaveSize = 7. * keyHeightW;
    static constexpr qreal pianoHeight = octaveSize * 10. + keyHeightW * 5. + 1.;

    static const QColor colKeyW("Ivory");
    static const QColor colKeyCur = QColor("DeepSkyBlue");
    static const QColor colKeySel = QColor("#FFFF6E");
//    static const QColor colKeySel = QColor("PeachPuff");
    ...
    int selPitchY = pitch2y(selectedPitch);
    int curPitchY = pitch2y(curPitch);
    qreal w = pianoWidth;
    ...
    // draw C notes
    {
        ...
        for (int i = 0; i < 11; i++) {
            p.drawText(w * .65, y - 3., "C" + QString::number(8 - i));
            y += octaveSize;
        }
    }
...
//             emit keyPressed(keyDown, velocity>127 ? 127 : velocity, shift); //emit keyPressed(keyDown, shift);
      ...
      if (keyDown != -1 && keyDown != selectedPitch) {
            selectedPitch = keyDown;
