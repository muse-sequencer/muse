...
void initShortCuts()
      ...
      defShrt(SHRT_ARRANGER,      Qt::ALT + Qt::Key_A, QT_TRANSLATE_NOOP("shortcuts", "Show Arranger window"), GLOBAL_SHRT, "arranger");
...
//      defShrt(SHRT_DESEL_PARTS,           Qt::CTRL + Qt::Key_B, QT_TRANSLATE_NOOP("shortcuts", "Deselect all parts"), ARRANG_SHRT, "deselect_parts");
      ...
      defShrt(SHRT_OPEN_PIANO_NEW,        Qt::CTRL + Qt::ALT + Qt::Key_E, QT_TRANSLATE_NOOP("shortcuts", "Open pianoroll in new window"), ARRANG_SHRT, "open_pianoroll_new");
      defShrt(SHRT_OPEN_DRUMS_NEW,        Qt::CTRL + Qt::ALT + Qt::Key_D, QT_TRANSLATE_NOOP("shortcuts", "Open drumeditor in new window"), ARRANG_SHRT, "open_drumedit_new");
      defShrt(SHRT_OPEN_LIST_NEW,         Qt::CTRL + Qt::ALT + Qt::Key_L, QT_TRANSLATE_NOOP("shortcuts", "Open listeditor in new window"), ARRANG_SHRT, "open_listedit_new");
      defShrt(SHRT_OPEN_WAVE_NEW,         Qt::CTRL + Qt::ALT + Qt::Key_Y, QT_TRANSLATE_NOOP("shortcuts", "Open waveeditor in new window"), ARRANG_SHRT, "open_waveeditor_new");
