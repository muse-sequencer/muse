...
// REMOVE Tim. Midi fixes. Changed. And renamed as putEvent
// //---------------------------------------------------------
// //   putMidiEvent
// //---------------------------------------------------------
// 
...
// REMOVE Tim. Midi fixes. Added. Renamed and altered from putMidiEvent
//---------------------------------------------------------
//   putEvent
...
// REMOVE Tim. Midi fixes. Switched to 0
#if 0
                  snd_seq_ev_set_controller(&event, chn, a, b);
#else
