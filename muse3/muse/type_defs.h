...
#define SC_AUDIO_CONVERTER            0x8000000000 // Audio converters settings or value lists changed.
#define SC_AUDIO_STRETCH              0x10000000000 // Audio converters stretch/pitch ratios changed.
