...
namespace MusECore {
  ...
  unsigned int QtTimer::setTimerResolution(unsigned int)
    {
    return 0;
    }
  
  unsigned int QtTimer::setTimerFreq(unsigned int freq)
    {
    if (freq > 1000)
      freq = 1000;
    if (freq < 100)
  ...
  unsigned int QtTimer::getTimerResolution()
    {
    return  20;
    }

  unsigned int QtTimer::getTimerFreq()
    {
    return 1000/timeoutms;
    }
  ...
  unsigned int  QtTimer::getTimerTicks(bool /*printTicks*/)
    {
