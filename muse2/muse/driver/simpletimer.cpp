...
namespace MusECore {
  ...
  signed int SimpleTimer::initTimer()
    {
    if(TIMER_DEBUG)
  ...
  unsigned int SimpleTimer::setTimerResolution(unsigned int)
    {
    return 0;
    }
  
  unsigned int SimpleTimer::setTimerFreq(unsigned int )
    {
    return 1000;
    }
  
  unsigned int SimpleTimer::getTimerResolution()
    {
    return  20;
    }

  unsigned int SimpleTimer::getTimerFreq()
    {
    return 1000;
    }
  ...
  unsigned int  SimpleTimer::getTimerTicks(bool /*printTicks*/)
    {
    return tickCount;
    }
