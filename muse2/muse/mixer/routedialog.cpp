...
const QString RouteDialog::midiDevicesCat(QObject::tr("Midi ports/devices:"));
...
/*  
  QList<QTreeWidgetItem*> srcSel = newSrcList->selectedItems();
  QList<QTreeWidgetItem*> dstSel = newDstList->selectedItems();
