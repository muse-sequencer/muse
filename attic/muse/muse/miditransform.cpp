...
MidiTransformerDialog::MidiTransformerDialog(QWidget* parent,
   ...
   : MidiTransformDialogBase(parent, name, modal, fl)
      ...
      connect(presetList,   SIGNAL(highlighted(QListBoxItem*)),
         SLOT(presetChanged(QListBoxItem*)));
...
void MidiTransformerDialog::presetNew()
      ...
      QListBoxText* lbi      = new QListBoxText(presetList, name);
      mtlist.push_back(mt);
...
void MidiTransformerDialog::presetChanged(QListBoxItem* item)
      {
...
void MidiTransformerDialog::nameChanged(const QString& s)
      {
      data->cmt->name = s;
      QListBoxItem* item = presetList->item(data->cindex);
      if (s != item->text()) {
            disconnect(presetList, SIGNAL(highlighted(QListBoxItem*)),
               this, SLOT(presetChanged(QListBoxItem*)));
