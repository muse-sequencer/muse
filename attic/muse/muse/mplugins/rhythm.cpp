...
RhythmGen::RhythmGen(QWidget* parent, const char* name, WFlags fo)
 ...
 */
RhythmGenerator::RhythmGenerator( QWidget* parent,  const char* name, bool modal, WFlags fl )
    : QDialog( parent, name, modal, fl )
{
    ...
    RhythmGeneratorLayout = new QVBoxLayout( this, 11, 6, "RhythmGeneratorLayout");
    ...
    Layout17 = new QHBoxLayout( 0, 0, 15, "Layout17");
    ...
    InstrumentList = new QListBox( Frame6, "InstrumentList" );
    ...
    StepsLayout = new QHBoxLayout( 0, 0, 6, "StepsLayout");
    ...
    CountLayout = new QHBoxLayout( 0, 0, 6, "CountLayout");

    CountSlider = new QSlider( Frame6, "CountSlider" );
    CountSlider->setMaxValue( 16 );
    CountSlider->setValue( 4 );
    CountSlider->setOrientation( QSlider::Horizontal );
    ...
    BarsLayout = new QHBoxLayout( 0, 0, 6, "BarsLayout");

    BarsSlider = new QSlider( Frame6, "BarsSlider" );
    BarsSlider->setMaxValue( 16 );
    BarsSlider->setValue( 1 );
    BarsSlider->setOrientation( QSlider::Horizontal );
    ...
    Layout27 = new QHBoxLayout( 0, 0, 15, "Layout27");
    ...
    Layout20_2 = new QHBoxLayout( 0, 0, 15, "Layout20_2");

    GroupListLayout = new QVBoxLayout( 0, 0, 6, "GroupListLayout");
    ...
    GroupList = new QListBox( Frame5, "GroupList" );
    ...
    ListenLayout = new QHBoxLayout( 0, 0, 6, "ListenLayout");
    ...
    ListenSlider->setOrientation( QSlider::Horizontal );
    ...
    Frame5_2 = new QFrame( this, "Frame5_2" );
    ...
    Layout21 = new QVBoxLayout( 0, 0, 2, "Layout21");
    ...
    Layout22 = new QVBoxLayout( 0, 0, 2, "Layout22");
